...
if minimum(data_a["rain_w"][:, y_idx, :, time_idx]) != maximum(data_a["rain_w"][:, y_idx, :, time_idx])
    p5 = contourf(x, z, transpose(data_a["rain_w"][:, y_idx, :, time_idx]), ylabel=ylab, xlabel=xlab, levels=nlev, title="rain_w [m/s]", color=:haline)
end
p6 = plot(legend=false,grid=false,foreground_color_subplot=:white)
if minimum(data_a["snow_w"][:, y_idx, :, time_idx]) != maximum(data_a["snow_w"][:, y_idx, :, time_idx])
...
if minimum(data_a["q_liq"][:, y_idx, :, time_idx]) != maximum(data_a["q_liq"][:, y_idx, :, time_idx])
...
if minimum(data_a["q_ice"][:, y_idx, :, time_idx]) != maximum(data_a["q_ice"][:, y_idx, :, time_idx])
    p4 = contourf(x, z, transpose(data_a["q_ice"][:, y_idx, :, time_idx])*1e3, levels=nlev, title="q_ice [g/kg]", color=:haline)
end
p5 = plot(legend=false,grid=false,foreground_color_subplot=:white)
if minimum(data_a["q_rai"][:, y_idx, :, time_idx]) != maximum(data_a["q_rai"][:, y_idx, :, time_idx])
...
p6 = plot(legend=false,grid=false,foreground_color_subplot=:white)
if minimum(data_a["q_sno"][:, y_idx, :, time_idx]) != maximum(data_a["q_sno"][:, y_idx, :, time_idx])
...
if minimum(data_a["S_liq"][:, y_idx, :, time_idx]) != maximum(data_a["S_liq"][:, y_idx, :, time_idx])
...
if minimum(data_a["S_ice"][:, y_idx, :, time_idx]) != maximum(data_a["S_ice"][:, y_idx, :, time_idx])
    p2 = contourf(x, z, transpose(data_a["S_ice"][:, y_idx, :, time_idx])*1e3, levels=nlev, title="S_ice [-]", color=:haline)
end
p3 = plot(legend=false,grid=false,foreground_color_subplot=:white)
if minimum(data_a["flag_cloud_liq"][:, y_idx, :, time_idx]) != maximum(data_a["flag_cloud_liq"][:, y_idx, :, time_idx])
...
p4 = plot(legend=false,grid=false,foreground_color_subplot=:white)
if minimum(data_a["flag_cloud_ice"][:, y_idx, :, time_idx]) != maximum(data_a["flag_cloud_ice"][:, y_idx, :, time_idx])
    p4 = contourf(x, z, transpose(data_a["flag_cloud_ice"][:, y_idx, :, time_idx])*1e3, levels=nlev, title="flag cloud ice", color=:haline)
end
p5 = plot(legend=false,grid=false,foreground_color_subplot=:white)
if minimum(data_a["flag_rain"][:, y_idx, :, time_idx]) != maximum(data_a["flag_rain"][:, y_idx, :, time_idx])
...
p6 = plot(legend=false,grid=false,foreground_color_subplot=:white)
if minimum(data_a["flag_snow"][:, y_idx, :, time_idx]) != maximum(data_a["flag_snow"][:, y_idx, :, time_idx])
