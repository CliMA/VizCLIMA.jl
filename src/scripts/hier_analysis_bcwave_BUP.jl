...
CLIMA_ANALYSIS = "/central/scratch/elencz/output/hier_RH100_q_active_SAdbbbb/analysis"
CLIMA_NETCDF = "/central/scratch/elencz/output/hier_RH100_q_active_SAdbbbb/netcdf"
CLIMA_LOGFILE = "/central/scratch/elencz/output/hier_RH100_q_active_SAdbbbb/log/experiments_performance_log"
RUNNAME = "hier_RH100_q_active_SAdbbbb"
...
if print_table =="true"
  ...
  for i in 2:nexp[1]+1
    ...
    time, z, lat, lon, dummy = get_var( "$CLIMA_NETCDF/"fname[1], var_name_list[1], t_spinup, nan_fill_value);
